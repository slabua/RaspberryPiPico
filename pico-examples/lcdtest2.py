...
def print_and_wait(text: str, sleep_time: int = 0.5) -> None:
    """
...
lcd.create_char(
    location=0,
    charmap=[0x00, 0x00, 0x11, 0x00, 0x04, 0x11, 0x0E, 0x00]
...
lcd.create_char(location=1, charmap=[0x00, 0x00, 0x0A, 0x1F, 0x1F, 0x0E, 0x04, 0x00])
...
sleep(1)
# show custom char stored at location 1
lcd.print(chr(1))
print_and_wait("Show custom char")
